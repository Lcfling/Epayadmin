...
@section('content')
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" value="{{$info['mobile']}}" class="layui-input" disabled>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" value="{{$info['wx_name']}}" class="layui-input" disabled>
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <script>
        layui.use(['form','jquery','laypage', 'layer'], function() {
            ...
            form.on('submit(formDemo)', function(data) {
                $.ajax({
                    url:"{{url('/admin/codedrawnonereject')}}",
                    data:$('form').serialize(),
                    type:'post',
                    dataType:'json',
