    ...
    <table class="layui-table" lay-even lay-skin="nob">
        ...
        @foreach($list as $info)
            <tr>
                ...
                <td class="hidden-xs">
                    @if($info['callback_status']==0)<span class="layui-btn layui-btn-small layui-btn-primary">未处理</span>@elseif($info['callback_status']==1)<span span class="layui-btn layui-btn-small layui-btn-warm">推送成功</span>@elseif($info['callback_status']==2)<span class="layui-btn layui-btn-small layui-btn-danger">推送失败</span>
                    @endif
                </td>
                ...
                <td style="text-align: center">
                    ...
                    <div class="layui-inline">
                        <button class="layui-btn layui-btn-small layui-btn-warm edits-btn2" data-id="{{$info['order_sn']}}" data-desc="手动冻结">手动冻结</button>
                    </div>
                </td>                
            </tr>
        @endforeach
            ...
            $('.edits-btn1').click(function () {
                ...
                layer.confirm('确定要补单吗？',{title:'提示'},function (index) {
                        $.ajax({
                            ...
                            url:"{{url('/admin/order/falsebudan')}}",
                            data:{
                                "order_sn":order_sn,
                            },
                            type:"post",
